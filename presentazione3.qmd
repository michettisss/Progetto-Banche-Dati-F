...
La creascita economica si traduce in miglioramenti dell'HDI? Quali sono i determinanti più influenti?
\end{block}
:::
...
## L'efficienza di trasformazione del reddito in sviluppo umano
\begin{itemize}
  \item \textbf{Coefficienti di interazione}: non tutti i paesi convertono l’aumento del reddito in miglioramenti dell’HDI con la stessa efficienza.
  \item Maggiore il coefficiente di interazione $log(gdp)*as.factor(country)$ $\rightarrow$ più efficiente è la trasformazione del reddito in sviluppo umano.
  \item \textbf{Sudafrica} $\rightarrow$ Mostra un coefficiente di interazione più alto, indicando una maggiore capacità di tradurre la crescita economica in miglioramenti dell’HDI rispetto agli altri paesi.
  \item \textbf{Senegal} $\rightarrow$ La crescita economica rimane "disconnessa" dal benessere sociale, suggerendo barriere strutturali o inefficienze nella spesa.
\end{itemize}
