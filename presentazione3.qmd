...
format:
  beamer:
    ...
    header-includes: |
      \usepackage{booktabs}
      \definecolor{sprucegreen}{RGB}{10, 45, 90}
      \setbeamercolor{frametitle}{bg=sprucegreen, fg=white}
      \setbeamercolor{title separator}{fg=sprucegreen}
      \setbeamercolor{progress bar}{fg=sprucegreen}
      \setbeamerfont{title}{size=\LARGE}
      \setbeamerfont{subtitle}{size=\large}
      \setbeamertemplate{footline}{}
      \setbeamertemplate{navigation symbols}{}
      \setbeamercolor{block title}{bg=sprucegreen, fg=white}
      \setbeamercolor{block body}{bg=sprucegreen!10, fg=black}
      \setbeamerfont{title}{size=\LARGE}
      \setbeamerfont{subtitle}{size=\large}
      \setbeamertemplate{footline}{}
      \setbeamertemplate{navigation symbols}{}
...
\begin{itemize}
  ...
  \item \textbf{Il Sudafrica} $\rightarrow$ Mostra un coefficiente di interazione più alto, indicando una maggiore capacità di tradurre la crescita economica in miglioramenti dell’HDI rispetto agli altri paesi.
